...
export function SystemPage() {
  ...
  const fetchModelsAndStats = async ({ forceRefresh = false }: { forceRefresh?: boolean } = {}) => {
    ...
    try {
      const managementKey = auth.managementKey;
      const list = await fetchModelsFromStore(auth.apiBase, managementKey, forceRefresh);
      ...
      <div className={styles.content}>
        <Card className={styles.aboutCard}>
          <div className={styles.aboutHeader}>
            <img src={INLINE_LOGO_JPEG} alt="logo" className={styles.aboutLogo} />
